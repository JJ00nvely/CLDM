...
from cldm_trainer_2 import TrainLoopCLDM
...
def main(*args, **kwargs):
    ...
    model = CLDM(latent_dim=config.latent_dim, num_layers = config.num_layers, 
                ...
                cond_emb_size=config.cond_emb_size, use_temp=config.use_temp).to(accelerator.device)
    
    # Load the Image Space Layout Generation Model here
    save_path = "/workspace/joonsm/City_Layout/log_dir/baseline_512/checkpoints/checkpoint-200/pytorch_model.bin"
